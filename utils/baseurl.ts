...
// 默认 baseURL（需要与 api/config/index.ts 中的 config.baseURL 保持一致）
export const DEFAULT_BASE_URL = 'https://buy.fj-mingu.cn/'

// localStorage 键名（使用项目前缀避免与其他应用冲突）
const STORAGE_KEY_CURRENT = 'bid_baseurl_current'
const STORAGE_KEY_LIST = 'bid_baseurl_list'
